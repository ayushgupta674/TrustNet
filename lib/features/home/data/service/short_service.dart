...
class ShortsService {
  Future<List<ShortModel>> fetchShorts() async {
    ...
    return [
      ShortModel(id: '1', title: '🌱 Green Earth Initiative', creatorName: 'EcoWarriors', description: 'Join us to plant 1000 trees! aihfhohaodfhohoha  hia dfiooa oaj df ao of oa  iah fa h oah  oihadfhoa h iaf '),
